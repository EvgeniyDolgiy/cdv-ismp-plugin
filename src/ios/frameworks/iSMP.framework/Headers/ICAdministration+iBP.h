...
enum eiBPResult {
    ...
    iBPResult_PRINTER_BUFFER_EMPTY,             /**< Printer FIFO is empty */
    iBPResult_PRINTING_ENDED                    /**< End of printing (at physical level) */
};
...
+(NSString *)iBPVersion __attribute__((deprecated));
